...
export const FloatingAIButton = ({
  ...
  return <div className="fixed top-8 right-8 z-50">
      <div className="relative">
        {/* Particle Container */}
        <div ref={particleContainerRef} className="particle-container absolute" style={{
        ...
        {/* Button */}
        <button ref={buttonRef} onClick={onClick} aria-label="Open AI Task Creator" className="relative w-14 h-14 sm:w-16 sm:h-16 rounded-full text-primary-foreground font-black text-2xl sm:text-3xl shadow-lg shadow-primary/30 hover:shadow-primary/50 hover:scale-105 transition-all duration-300 flex items-center justify-center border-2 border-primary-foreground/10 bg-inherit">
          P
        </button>
      </div>
    </div>;
