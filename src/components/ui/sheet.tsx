...
const SheetContent = React.forwardRef<React.ElementRef<typeof SheetPrimitive.Content>, SheetContentProps>(
  ({ side = "right", className, children, disableOverlayPointerEvents, disableOutsideInteraction, ...props }, ref) => (
    <SheetPortal>
      <SheetOverlay disablePointerEvents={disableOverlayPointerEvents} />
      <SheetPrimitive.Content 
        ref={ref} 
        className={cn(sheetVariants({ side }), className)} 
        onPointerDownOutside={disableOutsideInteraction ? (e) => e.preventDefault() : undefined}
